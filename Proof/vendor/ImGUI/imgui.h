...
enum ImGuiSliderFlags_
{
    ...
    ImGuiSliderFlags_AlwaysClamp            = 1 << 4,       // ClampEdge value to min/max bounds when input manually with CTRL+Click. By default CTRL+Click allows going out of bounds.
