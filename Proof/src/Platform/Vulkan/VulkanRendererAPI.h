...
namespace Proof {
   ...
   public:
	  ...
	  virtual void RecordRenderPass(Count<class RenderPass> renderPass, Count<class GraphicsPipeline>pipeline, std::function<void(Count<CommandBuffer> commandBuffer)> data) override;
	  ...
	  virtual void BeginCommandBuffer(Count<class CommandBuffer> commandBuffer)override;
	  virtual void EndCommandBuffer(Count<class CommandBuffer> commandBuffer)override;
