...
namespace Proof 
{
	...
	static Proof::AllocationStats s_GlobalStats;
...
{
	return Proof::Allocator::Allocate(size);
}
...
{
	return Proof::Allocator::Allocate(size, desc);
}
...
{
	return Proof::Allocator::Allocate(size, file, line);
}
...
{
	return Proof::Allocator::Free(memory);
}
