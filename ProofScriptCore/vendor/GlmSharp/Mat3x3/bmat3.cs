...
namespace Proof
{
    ...
    public struct bMatrix3 : IReadOnlyList<bool>, IEquatable<bMatrix3>
    {
        ...
        /// </summary>
        public bMatrix3(bool m00, bool m01, bool m02, bool m10, bool m11, bool m12, bool m20, bool m21, bool m22)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m02 = m02;
        ...
        /// </summary>
        public bMatrix3(bVector2 c0, bVector2 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix3(bVector2 c0, bVector2 c1, bVector2 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix3(bVector3 c0, bVector3 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix3(bVector3 c0, bVector3 c1, bVector3 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// </summary>
        public static bMatrix3 Zero { get; } = new bMatrix3(false, false, false, false, false, false, false, false, false);
        
        /// <summary>
        /// Predefined all-ones Matrix
        /// </summary>
        public static bMatrix3 Ones { get; } = new bMatrix3(true, true, true, true, true, true, true, true, true);
        
        /// <summary>
        /// Predefined identity Matrix
        /// </summary>
        public static bMatrix3 Identity { get; } = new bMatrix3(true, false, false, false, true, false, false, false, true);
        ...
        /// </summary>
        public bool Equals(bMatrix3 rhs) => ((((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && m02.Equals(rhs.m02)) && (m10.Equals(rhs.m10) && m11.Equals(rhs.m11))) && ((m12.Equals(rhs.m12) && m20.Equals(rhs.m20)) && (m21.Equals(rhs.m21) && m22.Equals(rhs.m22))));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is bMatrix3 && Equals((bMatrix3) obj);
        }
        
        /// <summary>
        /// Returns true iff this equals rhs component-wise.
        /// </summary>
        public static bool operator ==(bMatrix3 lhs, bMatrix3 rhs) => lhs.Equals(rhs);
        ...
        /// </summary>
        public bMatrix3 Transposed => new bMatrix3(m00, m10, m20, m01, m11, m21, m02, m12, m22);
        ...
        /// </summary>
        public static bMatrix3 operator&(bMatrix3 lhs, bMatrix3 rhs) => new bMatrix3(lhs.m00 && rhs.m00, lhs.m01 && rhs.m01, lhs.m02 && rhs.m02, lhs.m10 && rhs.m10, lhs.m11 && rhs.m11, lhs.m12 && rhs.m12, lhs.m20 && rhs.m20, lhs.m21 && rhs.m21, lhs.m22 && rhs.m22);
