...
namespace Proof
{
    ...
    public struct bMatrix4x3 : IReadOnlyList<bool>, IEquatable<bMatrix4x3>
    {
        ...
        /// </summary>
        public bMatrix4x3(bool m00, bool m01, bool m02, bool m10, bool m11, bool m12, bool m20, bool m21, bool m22, bool m30, bool m31, bool m32)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m02 = m02;
        ...
        /// </summary>
        public bMatrix4x3(bMatrix3x2 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = false;
        ...
        /// </summary>
        public bMatrix4x3(bMatrix4x2 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = false;
        ...
        /// </summary>
        public bMatrix4x3(bMatrix2x3 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = m.m02;
        ...
        /// </summary>
        public bMatrix4x3(bMatrix4x3 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = m.m02;
        ...
        /// </summary>
        public bMatrix4x3(bMatrix2x4 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = m.m02;
        ...
        /// </summary>
        public bMatrix4x3(bMatrix3x4 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = m.m02;
        ...
        /// </summary>
        public bMatrix4x3(bVector2 c0, bVector2 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectortors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4x3(bVector2 c0, bVector2 c1, bVector2 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectortors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4x3(bVector2 c0, bVector2 c1, bVector2 c2, bVector2 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectortors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4x3(bVector3 c0, bVector3 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectortors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4x3(bVector3 c0, bVector3 c1, bVector3 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectortors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4x3(bVector3 c0, bVector3 c1, bVector3 c2, bVector3 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// </summary>
        public bVector3 Column2
        {
            get
            {
                return new bVector3(m20, m21, m22);
            }
            set
            {
                m20 = value.x;
        ...
        /// </summary>
        public bVector3 Column3
        {
            get
            {
                return new bVector3(m30, m31, m32);
            }
            set
            {
                m30 = value.x;
        ...
        /// </summary>
        public static bMatrix4x3 Zero { get; } = new bMatrix4x3(false, false, false, false, false, false, false, false, false, false, false, false);
        
        /// <summary>
        /// Predefined all-ones Matrix
        /// </summary>
        public static bMatrix4x3 Ones { get; } = new bMatrix4x3(true, true, true, true, true, true, true, true, true, true, true, true);
        
        /// <summary>
        /// Predefined identity Matrix
        /// </summary>
        public static bMatrix4x3 Identity { get; } = new bMatrix4x3(true, false, false, false, true, false, false, false, true, false, false, false);
        ...
        /// </summary>
        public bool Equals(bMatrix4x3 rhs) => ((((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && m02.Equals(rhs.m02)) && ((m10.Equals(rhs.m10) && m11.Equals(rhs.m11)) && m12.Equals(rhs.m12))) && (((m20.Equals(rhs.m20) && m21.Equals(rhs.m21)) && m22.Equals(rhs.m22)) && ((m30.Equals(rhs.m30) && m31.Equals(rhs.m31)) && m32.Equals(rhs.m32))));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is bMatrix4x3 && Equals((bMatrix4x3) obj);
        }
        
        /// <summary>
        /// Returns true iff this equals rhs component-wise.
        /// </summary>
        public static bool operator ==(bMatrix4x3 lhs, bMatrix4x3 rhs) => lhs.Equals(rhs);
        ...
        /// </summary>
        public bMatrix3x4 Transposed => new bMatrix3x4(m00, m10, m20, m30, m01, m11, m21, m31, m02, m12, m22, m32);
        ...
        /// </summary>
        public static bMatrix4x3 operator&(bMatrix4x3 lhs, bMatrix4x3 rhs) => new bMatrix4x3(lhs.m00 && rhs.m00, lhs.m01 && rhs.m01, lhs.m02 && rhs.m02, lhs.m10 && rhs.m10, lhs.m11 && rhs.m11, lhs.m12 && rhs.m12, lhs.m20 && rhs.m20, lhs.m21 && rhs.m21, lhs.m22 && rhs.m22, lhs.m30 && rhs.m30, lhs.m31 && rhs.m31, lhs.m32 && rhs.m32);
