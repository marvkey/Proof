...
namespace Proof
{
    ...
    public struct bMatrix4x2 : IReadOnlyList<bool>, IEquatable<bMatrix4x2>
    {
        ...
        /// </summary>
        public bMatrix4x2(bool m00, bool m01, bool m10, bool m11, bool m20, bool m21, bool m30, bool m31)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m10 = m10;
        ...
        /// </summary>
        public bMatrix4x2(bMatrix3x2 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m10 = m.m10;
        ...
        /// </summary>
        public bMatrix4x2(bMatrix4x2 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m10 = m.m10;
        ...
        /// </summary>
        public bMatrix4x2(bMatrix2x3 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m10 = m.m10;
        ...
        /// </summary>
        public bMatrix4x2(bMatrix4x3 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m10 = m.m10;
        ...
        /// </summary>
        public bMatrix4x2(bMatrix2x4 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m10 = m.m10;
        ...
        /// </summary>
        public bMatrix4x2(bMatrix3x4 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m10 = m.m10;
        ...
        /// </summary>
        public bMatrix4x2(bVector2 c0, bVector2 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m10 = c1.x;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4x2(bVector2 c0, bVector2 c1, bVector2 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m10 = c1.x;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4x2(bVector2 c0, bVector2 c1, bVector2 c2, bVector2 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m10 = c1.x;
        ...
        /// </summary>
        public bVector2 Column2
        {
            get
            {
                return new bVector2(m20, m21);
            }
            set
            {
                m20 = value.x;
        ...
        /// </summary>
        public bVector2 Column3
        {
            get
            {
                return new bVector2(m30, m31);
            }
            set
            {
                m30 = value.x;
        ...
        /// </summary>
        public static bMatrix4x2 Zero { get; } = new bMatrix4x2(false, false, false, false, false, false, false, false);
        
        /// <summary>
        /// Predefined all-ones Matrix
        /// </summary>
        public static bMatrix4x2 Ones { get; } = new bMatrix4x2(true, true, true, true, true, true, true, true);
        
        /// <summary>
        /// Predefined identity Matrix
        /// </summary>
        public static bMatrix4x2 Identity { get; } = new bMatrix4x2(true, false, false, true, false, false, false, false);
        ...
        /// </summary>
        public bool Equals(bMatrix4x2 rhs) => (((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && (m10.Equals(rhs.m10) && m11.Equals(rhs.m11))) && ((m20.Equals(rhs.m20) && m21.Equals(rhs.m21)) && (m30.Equals(rhs.m30) && m31.Equals(rhs.m31))));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is bMatrix4x2 && Equals((bMatrix4x2) obj);
        }
        
        /// <summary>
        /// Returns true iff this equals rhs component-wise.
        /// </summary>
        public static bool operator ==(bMatrix4x2 lhs, bMatrix4x2 rhs) => lhs.Equals(rhs);
        ...
        /// </summary>
        public bMatrix2x4 Transposed => new bMatrix2x4(m00, m10, m20, m30, m01, m11, m21, m31);
        ...
        /// </summary>
        public static bMatrix4x2 operator&(bMatrix4x2 lhs, bMatrix4x2 rhs) => new bMatrix4x2(lhs.m00 && rhs.m00, lhs.m01 && rhs.m01, lhs.m10 && rhs.m10, lhs.m11 && rhs.m11, lhs.m20 && rhs.m20, lhs.m21 && rhs.m21, lhs.m30 && rhs.m30, lhs.m31 && rhs.m31);
