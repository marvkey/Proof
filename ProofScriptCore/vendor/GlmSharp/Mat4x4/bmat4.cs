...
namespace Proof
{
    ...
    public struct bMatrix4 : IReadOnlyList<bool>, IEquatable<bMatrix4>
    {
        ...
        /// </summary>
        public bMatrix4(bool m00, bool m01, bool m02, bool m03, bool m10, bool m11, bool m12, bool m13, bool m20, bool m21, bool m22, bool m23, bool m30, bool m31, bool m32, bool m33)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m02 = m02;
        ...
        /// </summary>
        public bMatrix4(bVector2 c0, bVector2 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4(bVector2 c0, bVector2 c1, bVector2 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4(bVector2 c0, bVector2 c1, bVector2 c2, bVector2 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4(bVector3 c0, bVector3 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4(bVector3 c0, bVector3 c1, bVector3 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4(bVector3 c0, bVector3 c1, bVector3 c2, bVector3 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4(bVector4 c0, bVector4 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4(bVector4 c0, bVector4 c1, bVector4 c2)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix4(bVector4 c0, bVector4 c1, bVector4 c2, bVector4 c3)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// </summary>
        public bVector4 Column0
        {
            get
            {
                return new bVector4(m00, m01, m02, m03);
            }
            set
            {
                m00 = value.x;
        ...
        public bVector4 Column1
        {
            get
            {
                return new bVector4(m10, m11, m12, m13);
            }
            set
            {
                m10 = value.x;
        ...
        public bVector4 Column2
        {
            get
            {
                return new bVector4(m20, m21, m22, m23);
            }
            set
            {
                m20 = value.x;
        ...
        public bVector4 Column3
        {
            get
            {
                return new bVector4(m30, m31, m32, m33);
            }
            set
            {
                m30 = value.x;
        ...
        /// </summary>
        public bVector4 Row0
        {
            get
            {
                return new bVector4(m00, m10, m20, m30);
            }
            set
            {
                m00 = value.x;
        ...
        public bVector4 Row1
        {
            get
            {
                return new bVector4(m01, m11, m21, m31);
            }
            set
            {
                m01 = value.x;
        ...
        public bVector4 Row2
        {
            get
            {
                return new bVector4(m02, m12, m22, m32);
            }
            set
            {
                m02 = value.x;
        ...
        public bVector4 Row3
        {
            get
            {
                return new bVector4(m03, m13, m23, m33);
            }
            set
            {
                m03 = value.x;
        ...
        /// </summary>
        public static bMatrix4 Zero { get; } = new bMatrix4(false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
        
        /// <summary>
        /// Predefined all-ones Matrix
        /// </summary>
        public static bMatrix4 Ones { get; } = new bMatrix4(true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true);
        
        /// <summary>
        /// Predefined identity Matrix
        /// </summary>
        public static bMatrix4 Identity { get; } = new bMatrix4(true, false, false, false, false, true, false, false, false, false, true, false, false, false, false, true);
        ...
        /// </summary>
        public bool Equals(bMatrix4 rhs) => ((((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && (m02.Equals(rhs.m02) && m03.Equals(rhs.m03))) && ((m10.Equals(rhs.m10) && m11.Equals(rhs.m11)) && (m12.Equals(rhs.m12) && m13.Equals(rhs.m13)))) && (((m20.Equals(rhs.m20) && m21.Equals(rhs.m21)) && (m22.Equals(rhs.m22) && m23.Equals(rhs.m23))) && ((m30.Equals(rhs.m30) && m31.Equals(rhs.m31)) && (m32.Equals(rhs.m32) && m33.Equals(rhs.m33)))));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is bMatrix4 && Equals((bMatrix4) obj);
        }
        
        /// <summary>
        /// Returns true iff this equals rhs component-wise.
        /// </summary>
        public static bool operator ==(bMatrix4 lhs, bMatrix4 rhs) => lhs.Equals(rhs);
        ...
        /// </summary>
        public bMatrix4 Transposed => new bMatrix4(m00, m10, m20, m30, m01, m11, m21, m31, m02, m12, m22, m32, m03, m13, m23, m33);
        ...
        /// </summary>
        public static bMatrix4 operator&(bMatrix4 lhs, bMatrix4 rhs) => new bMatrix4(lhs.m00 && rhs.m00, lhs.m01 && rhs.m01, lhs.m02 && rhs.m02, lhs.m03 && rhs.m03, lhs.m10 && rhs.m10, lhs.m11 && rhs.m11, lhs.m12 && rhs.m12, lhs.m13 && rhs.m13, lhs.m20 && rhs.m20, lhs.m21 && rhs.m21, lhs.m22 && rhs.m22, lhs.m23 && rhs.m23, lhs.m30 && rhs.m30, lhs.m31 && rhs.m31, lhs.m32 && rhs.m32, lhs.m33 && rhs.m33);
