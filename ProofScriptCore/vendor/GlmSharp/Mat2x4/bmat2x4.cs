...
namespace Proof
{
    ...
    public struct bMatrix2x4 : IReadOnlyList<bool>, IEquatable<bMatrix2x4>
    {
        ...
        /// </summary>
        public bMatrix2x4(bool m00, bool m01, bool m02, bool m03, bool m10, bool m11, bool m12, bool m13)
        {
            this.m00 = m00;
            this.m01 = m01;
            this.m02 = m02;
        ...
        /// </summary>
        public bMatrix2x4(bMatrix3x2 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = false;
        ...
        /// </summary>
        public bMatrix2x4(bMatrix4x2 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = false;
        ...
        /// </summary>
        public bMatrix2x4(bMatrix2x3 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = m.m02;
        ...
        /// </summary>
        public bMatrix2x4(bMatrix4x3 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = m.m02;
        ...
        /// </summary>
        public bMatrix2x4(bMatrix2x4 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = m.m02;
        ...
        /// </summary>
        public bMatrix2x4(bMatrix3x4 m)
        {
            this.m00 = m.m00;
            this.m01 = m.m01;
            this.m02 = m.m02;
        ...
        /// </summary>
        public bMatrix2x4(bVector2 c0, bVector2 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = false;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix2x4(bVector3 c0, bVector3 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// Constructs this Matrix from a series of column Vectors. Non-overwritten fields are from an Identity Matrix.
        /// </summary>
        public bMatrix2x4(bVector4 c0, bVector4 c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m02 = c0.z;
        ...
        /// </summary>
        public bVector2 Row3
        {
            get
            {
                return new bVector2(m03, m13);
            }
            set
            {
                m03 = value.x;
        ...
        /// </summary>
        public static bMatrix2x4 Zero { get; } = new bMatrix2x4(false, false, false, false, false, false, false, false);
        
        /// <summary>
        /// Predefined all-ones Matrix
        /// </summary>
        public static bMatrix2x4 Ones { get; } = new bMatrix2x4(true, true, true, true, true, true, true, true);
        
        /// <summary>
        /// Predefined identity Matrix
        /// </summary>
        public static bMatrix2x4 Identity { get; } = new bMatrix2x4(true, false, false, false, false, true, false, false);
        ...
        /// </summary>
        public bool Equals(bMatrix2x4 rhs) => (((m00.Equals(rhs.m00) && m01.Equals(rhs.m01)) && (m02.Equals(rhs.m02) && m03.Equals(rhs.m03))) && ((m10.Equals(rhs.m10) && m11.Equals(rhs.m11)) && (m12.Equals(rhs.m12) && m13.Equals(rhs.m13))));
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is bMatrix2x4 && Equals((bMatrix2x4) obj);
        }
        
        /// <summary>
        /// Returns true iff this equals rhs component-wise.
        /// </summary>
        public static bool operator ==(bMatrix2x4 lhs, bMatrix2x4 rhs) => lhs.Equals(rhs);
        ...
        /// </summary>
        public bMatrix4x2 Transposed => new bMatrix4x2(m00, m10, m01, m11, m02, m12, m03, m13);
        ...
        /// </summary>
        public static bMatrix2x4 operator&(bMatrix2x4 lhs, bMatrix2x4 rhs) => new bMatrix2x4(lhs.m00 && rhs.m00, lhs.m01 && rhs.m01, lhs.m02 && rhs.m02, lhs.m03 && rhs.m03, lhs.m10 && rhs.m10, lhs.m11 && rhs.m11, lhs.m12 && rhs.m12, lhs.m13 && rhs.m13);
