...
namespace Proof
{
    ...
    public static partial class glm
    {
        ...
        /// </summary>
        public static swizzle_gVector2<T> swizzle<T>(gVector2<T> v) => v.swizzle;
        
        /// <summary>
        /// Returns an array with all values
        /// </summary>
        public static T[] Values<T>(gVector2<T> v) => v.Values;
        ...
        /// </summary>
        public static int Count<T>(gVector2<T> v) => v.Count;
        
        /// <summary>
        /// Returns true iff this equals rhs component-wise.
        /// </summary>
        public static bool Equals<T>(gVector2<T> v, gVector2<T> rhs) => v.Equals(rhs);
        
        /// <summary>
        /// Returns true iff this equals rhs type- and component-wise.
        /// </summary>
        public static bool Equals<T>(gVector2<T> v, object obj) => v.Equals(obj);
        
        /// <summary>
        /// Returns a hash code for this instance.
        /// </summary>
        public static int GetHashCode<T>(gVector2<T> v) => v.GetHashCode();
        
        /// <summary>
        /// Returns a bVector2 from component-wise application of Equal (EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
        /// </summary>
        public static bVector2 Equal<T>(gVector2<T> lhs, gVector2<T> rhs) => gVector2<T>.Equal(lhs, rhs);
        
        /// <summary>
        /// Returns a bVector2 from component-wise application of NotEqual (!EqualityComparer&lt;T&gt;.Default.Equals(lhs, rhs)).
        /// </summary>
        public static bVector2 NotEqual<T>(gVector2<T> lhs, gVector2<T> rhs) => gVector2<T>.NotEqual(lhs, rhs);
